...
@interface FLTRenderCacheOptions : NSObject
...
/// @return `nil` only when `error != nil`.
- (nullable FLTCameraOptions *)cameraForCoordinates2Coordinates:(NSArray<NSDictionary<NSString *, id> *> *)coordinates camera:(FLTCameraOptions *)camera box:(FLTScreenBox *)box error:(FlutterError *_Nullable *_Nonnull)error;
/// @return `nil` only when `error != nil`.
...
- (void)setRenderCacheOptionsOptions:(FLTRenderCacheOptions *)options error:(FlutterError *_Nullable *_Nonnull)error;
/// @return `nil` only when `error != nil`.
- (nullable FLTRenderCacheOptions *)getRenderCacheOptionsWithError:(FlutterError *_Nullable *_Nonnull)error;
@end
