...
- (void)getCirclePitchAlignmentManagerId:(NSString *)managerId completion:(void (^)(FLTFLTCirclePitchAlignmentBox *_Nullable, FlutterError *_Nullable))completion;
...
- (void)getCirclePitchScaleManagerId:(NSString *)managerId completion:(void (^)(FLTFLTCirclePitchScaleBox *_Nullable, FlutterError *_Nullable))completion;
...
- (void)getCircleTranslateAnchorManagerId:(NSString *)managerId completion:(void (^)(FLTFLTCircleTranslateAnchorBox *_Nullable, FlutterError *_Nullable))completion;
@end
