...
- (NSDictionary *)toMap;
@end
@interface FLTRenderCacheOptions ()
+ (FLTRenderCacheOptions *)fromMap:(NSDictionary *)dict;
+ (nullable FLTRenderCacheOptions *)nullableFromMap:(NSDictionary *)dict;
- (NSDictionary *)toMap;
@end
...
@implementation FLTRenderCacheOptions
+ (instancetype)makeWithSize:(nullable NSNumber *)size {
  FLTRenderCacheOptions* pigeonResult = [[FLTRenderCacheOptions alloc] init];
  pigeonResult.size = size;
  return pigeonResult;
}
+ (FLTRenderCacheOptions *)fromMap:(NSDictionary *)dict {
...
+ (nullable FLTRenderCacheOptions *)nullableFromMap:(NSDictionary *)dict { return (dict) ? [FLTRenderCacheOptions fromMap:dict] : nil; }
- (NSDictionary *)toMap {
  return @{
    @"size" : (self.size ?: [NSNull null]),
  };
...
- (nullable id)readValueOfType:(UInt8)type 
{
  switch (type) {
    ...
    case 152:     
      return [FLTRenderCacheOptions fromMap:[self readValue]];
...
- (void)writeValue:(id)value 
{
  ...
  if ([value isKindOfClass:[FLTRenderCacheOptions class]]) {
    [self writeByte:152];
    [self writeValue:[value toMap]];
  } else 
...
void FLT_CameraManagerSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FLT_CameraManager> *api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon._CameraManager.cameraForCoordinates2"
        binaryMessenger:binaryMessenger
        codec:FLT_CameraManagerGetCodec()        ];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(cameraForCoordinates2Coordinates:camera:box:error:)], @"FLT_CameraManager api (%@) doesn't respond to @selector(cameraForCoordinates2Coordinates:camera:box:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        NSArray<NSDictionary<NSString *, id> *> *arg_coordinates = GetNullableObjectAtIndex(args, 0);
        ...
        FlutterError *error;
        FLTCameraOptions *output = [api cameraForCoordinates2Coordinates:arg_coordinates camera:arg_camera box:arg_box error:&error];
        callback(wrapResult(output, error));
      }];
    }
    else {
...
void FLT_MapInterfaceSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FLT_MapInterface> *api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon._MapInterface.setRenderCacheOptions"
        binaryMessenger:binaryMessenger
        codec:FLT_MapInterfaceGetCodec()        ];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setRenderCacheOptionsOptions:error:)], @"FLT_MapInterface api (%@) doesn't respond to @selector(setRenderCacheOptionsOptions:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        FLTRenderCacheOptions *arg_options = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        [api setRenderCacheOptionsOptions:arg_options error:&error];
        callback(wrapResult(nil, error));
      }];
    }
    else {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon._MapInterface.getRenderCacheOptions"
        binaryMessenger:binaryMessenger
        codec:FLT_MapInterfaceGetCodec()        ];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getRenderCacheOptionsWithError:)], @"FLT_MapInterface api (%@) doesn't respond to @selector(getRenderCacheOptionsWithError:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
        FLTRenderCacheOptions *output = [api getRenderCacheOptionsWithError:&error];
        callback(wrapResult(output, error));
      }];
    }
    else {
