...
private class CircleAnnotationMessengerPigeonCodecReader: FlutterStandardReader {
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 132:
      var enumResult: CirclePitchAlignment?
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as? Int)
      if let enumResultAsInt = enumResultAsInt {
        enumResult = CirclePitchAlignment(rawValue: enumResultAsInt)
      }
      return enumResult
    case 133:
      var enumResult: CirclePitchScale?
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as? Int)
      if let enumResultAsInt = enumResultAsInt {
        enumResult = CirclePitchScale(rawValue: enumResultAsInt)
      }
      return enumResult
    case 134:
      var enumResult: CircleTranslateAnchor?
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as? Int)
      if let enumResultAsInt = enumResultAsInt {
        enumResult = CircleTranslateAnchor(rawValue: enumResultAsInt)
      }
      return enumResult
    default:
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _CircleAnnotationMessenger?, messageChannelSuffix: String = "") {
    ...
    if let api = api {
      setCircleColorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let managerIdArg = args[0] as! String
        let circleColorArg = args[1] is Int64 ? args[1] as! Int64 : Int64(args[1] as! Int32)
    ...
    if let api = api {
      setCircleStrokeColorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let managerIdArg = args[0] as! String
        let circleStrokeColorArg = args[1] is Int64 ? args[1] as! Int64 : Int64(args[1] as! Int32)
