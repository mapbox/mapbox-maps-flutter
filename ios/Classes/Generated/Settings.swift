...
struct GesturesSettings {
  ...
  static func fromList(_ __pigeon_list: [Any?]) -> GesturesSettings? {
    let rotateEnabled: Bool? = nilOrValue(__pigeon_list[0])
    let pinchToZoomEnabled: Bool? = nilOrValue(__pigeon_list[1])
    let scrollEnabled: Bool? = nilOrValue(__pigeon_list[2])
    let simultaneousRotateAndPinchToZoomEnabled: Bool? = nilOrValue(__pigeon_list[3])
    let pitchEnabled: Bool? = nilOrValue(__pigeon_list[4])
    let scrollMode: ScrollMode? = nilOrValue(__pigeon_list[5])
    let doubleTapToZoomInEnabled: Bool? = nilOrValue(__pigeon_list[6])
    let doubleTouchToZoomOutEnabled: Bool? = nilOrValue(__pigeon_list[7])
    let quickZoomEnabled: Bool? = nilOrValue(__pigeon_list[8])
    let focalPoint: ScreenCoordinate? = nilOrValue(__pigeon_list[9])
    let pinchToZoomDecelerationEnabled: Bool? = nilOrValue(__pigeon_list[10])
    let rotateDecelerationEnabled: Bool? = nilOrValue(__pigeon_list[11])
    let scrollDecelerationEnabled: Bool? = nilOrValue(__pigeon_list[12])
    let increaseRotateThresholdWhenPinchingToZoom: Bool? = nilOrValue(__pigeon_list[13])
    let increasePinchToZoomThresholdWhenRotating: Bool? = nilOrValue(__pigeon_list[14])
    let zoomAnimationAmount: Double? = nilOrValue(__pigeon_list[15])
    let pinchPanEnabled: Bool? = nilOrValue(__pigeon_list[16])
...
struct LocationPuck2D {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> LocationPuck2D? {
    let topImage: FlutterStandardTypedData? = nilOrValue(__pigeon_list[0])
    let bearingImage: FlutterStandardTypedData? = nilOrValue(__pigeon_list[1])
    let shadowImage: FlutterStandardTypedData? = nilOrValue(__pigeon_list[2])
    let scaleExpression: String? = nilOrValue(__pigeon_list[3])
    let opacity: Double? = nilOrValue(__pigeon_list[4])
...
struct LocationPuck3D {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> LocationPuck3D? {
    let modelUri: String? = nilOrValue(__pigeon_list[0])
    let position: [Double?]? = nilOrValue(__pigeon_list[1])
    let modelOpacity: Double? = nilOrValue(__pigeon_list[2])
    let modelScale: [Double?]? = nilOrValue(__pigeon_list[3])
    let modelScaleExpression: String? = nilOrValue(__pigeon_list[4])
    let modelTranslation: [Double?]? = nilOrValue(__pigeon_list[5])
    let modelRotation: [Double?]? = nilOrValue(__pigeon_list[6])
    let modelCastShadows: Bool? = nilOrValue(__pigeon_list[7])
    let modelReceiveShadows: Bool? = nilOrValue(__pigeon_list[8])
    let modelScaleMode: ModelScaleMode? = nilOrValue(__pigeon_list[9])
    let modelEmissiveStrength: Double? = nilOrValue(__pigeon_list[10])
    let modelEmissiveStrengthExpression: String? = nilOrValue(__pigeon_list[11])
...
struct LocationPuck {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> LocationPuck? {
    let locationPuck2D: LocationPuck2D? = nilOrValue(__pigeon_list[0])
    let locationPuck3D: LocationPuck3D? = nilOrValue(__pigeon_list[1])
...
struct LocationComponentSettings {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> LocationComponentSettings? {
    let enabled: Bool? = nilOrValue(__pigeon_list[0])
    let pulsingEnabled: Bool? = nilOrValue(__pigeon_list[1])
    let pulsingColor: Int64? = isNullish(__pigeon_list[2]) ? nil : (__pigeon_list[2] is Int64? ? __pigeon_list[2] as! Int64? : Int64(__pigeon_list[2] as! Int32))
    let pulsingMaxRadius: Double? = nilOrValue(__pigeon_list[3])
    let showAccuracyRing: Bool? = nilOrValue(__pigeon_list[4])
    let accuracyRingColor: Int64? = isNullish(__pigeon_list[5]) ? nil : (__pigeon_list[5] is Int64? ? __pigeon_list[5] as! Int64? : Int64(__pigeon_list[5] as! Int32))
    let accuracyRingBorderColor: Int64? = isNullish(__pigeon_list[6]) ? nil : (__pigeon_list[6] is Int64? ? __pigeon_list[6] as! Int64? : Int64(__pigeon_list[6] as! Int32))
    let layerAbove: String? = nilOrValue(__pigeon_list[7])
    let layerBelow: String? = nilOrValue(__pigeon_list[8])
    let puckBearingEnabled: Bool? = nilOrValue(__pigeon_list[9])
    let puckBearing: PuckBearing? = nilOrValue(__pigeon_list[10])
    let slot: String? = nilOrValue(__pigeon_list[11])
    let locationPuck: LocationPuck? = nilOrValue(__pigeon_list[12])
...
struct ScaleBarSettings {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> ScaleBarSettings? {
    let enabled: Bool? = nilOrValue(__pigeon_list[0])
    let position: OrnamentPosition? = nilOrValue(__pigeon_list[1])
    let marginLeft: Double? = nilOrValue(__pigeon_list[2])
    let marginTop: Double? = nilOrValue(__pigeon_list[3])
    let marginRight: Double? = nilOrValue(__pigeon_list[4])
    let marginBottom: Double? = nilOrValue(__pigeon_list[5])
    let textColor: Int64? = isNullish(__pigeon_list[6]) ? nil : (__pigeon_list[6] is Int64? ? __pigeon_list[6] as! Int64? : Int64(__pigeon_list[6] as! Int32))
    let primaryColor: Int64? = isNullish(__pigeon_list[7]) ? nil : (__pigeon_list[7] is Int64? ? __pigeon_list[7] as! Int64? : Int64(__pigeon_list[7] as! Int32))
    let secondaryColor: Int64? = isNullish(__pigeon_list[8]) ? nil : (__pigeon_list[8] is Int64? ? __pigeon_list[8] as! Int64? : Int64(__pigeon_list[8] as! Int32))
    let borderWidth: Double? = nilOrValue(__pigeon_list[9])
    let height: Double? = nilOrValue(__pigeon_list[10])
    let textBarMargin: Double? = nilOrValue(__pigeon_list[11])
    let textBorderWidth: Double? = nilOrValue(__pigeon_list[12])
    let textSize: Double? = nilOrValue(__pigeon_list[13])
    let isMetricUnits: Bool? = nilOrValue(__pigeon_list[14])
    let refreshInterval: Int64? = isNullish(__pigeon_list[15]) ? nil : (__pigeon_list[15] is Int64? ? __pigeon_list[15] as! Int64? : Int64(__pigeon_list[15] as! Int32))
    let showTextBorder: Bool? = nilOrValue(__pigeon_list[16])
    let ratio: Double? = nilOrValue(__pigeon_list[17])
    let useContinuousRendering: Bool? = nilOrValue(__pigeon_list[18])
...
struct CompassSettings {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> CompassSettings? {
    let enabled: Bool? = nilOrValue(__pigeon_list[0])
    let position: OrnamentPosition? = nilOrValue(__pigeon_list[1])
    let marginLeft: Double? = nilOrValue(__pigeon_list[2])
    let marginTop: Double? = nilOrValue(__pigeon_list[3])
    let marginRight: Double? = nilOrValue(__pigeon_list[4])
    let marginBottom: Double? = nilOrValue(__pigeon_list[5])
    let opacity: Double? = nilOrValue(__pigeon_list[6])
    let rotation: Double? = nilOrValue(__pigeon_list[7])
    let visibility: Bool? = nilOrValue(__pigeon_list[8])
    let fadeWhenFacingNorth: Bool? = nilOrValue(__pigeon_list[9])
    let clickable: Bool? = nilOrValue(__pigeon_list[10])
    let image: FlutterStandardTypedData? = nilOrValue(__pigeon_list[11])
...
struct AttributionSettings {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> AttributionSettings? {
    let enabled: Bool? = nilOrValue(__pigeon_list[0])
    let iconColor: Int64? = isNullish(__pigeon_list[1]) ? nil : (__pigeon_list[1] is Int64? ? __pigeon_list[1] as! Int64? : Int64(__pigeon_list[1] as! Int32))
    let position: OrnamentPosition? = nilOrValue(__pigeon_list[2])
    let marginLeft: Double? = nilOrValue(__pigeon_list[3])
    let marginTop: Double? = nilOrValue(__pigeon_list[4])
    let marginRight: Double? = nilOrValue(__pigeon_list[5])
    let marginBottom: Double? = nilOrValue(__pigeon_list[6])
    let clickable: Bool? = nilOrValue(__pigeon_list[7])
...
struct LogoSettings {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> LogoSettings? {
    let enabled: Bool? = nilOrValue(__pigeon_list[0])
    let position: OrnamentPosition? = nilOrValue(__pigeon_list[1])
    let marginLeft: Double? = nilOrValue(__pigeon_list[2])
    let marginTop: Double? = nilOrValue(__pigeon_list[3])
...
private class SettingsPigeonCodecReader: FlutterStandardReader {
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 139:
      var enumResult: OrnamentPosition?
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as? Int)
      if let enumResultAsInt = enumResultAsInt {
        enumResult = OrnamentPosition(rawValue: enumResultAsInt)
      }
      return enumResult
    case 140:
      var enumResult: ScrollMode?
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as? Int)
      if let enumResultAsInt = enumResultAsInt {
        enumResult = ScrollMode(rawValue: enumResultAsInt)
      }
      return enumResult
    case 141:
      var enumResult: PuckBearing?
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as? Int)
      if let enumResultAsInt = enumResultAsInt {
        enumResult = PuckBearing(rawValue: enumResultAsInt)
      }
      return enumResult
    case 142:
      var enumResult: ModelScaleMode?
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as? Int)
      if let enumResultAsInt = enumResultAsInt {
        enumResult = ModelScaleMode(rawValue: enumResultAsInt)
      }
      return enumResult
    default:
...
private class SettingsPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? ScreenCoordinate {
      ...
      super.writeByte(138)
      super.writeValue(value.toList())
    } else if let value = value as? OrnamentPosition {
      super.writeByte(139)
