...
class _AnimationManagerSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _AnimationManager?) {
    let easeToChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._AnimationManager.easeTo", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let flyToChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._AnimationManager.flyTo", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let pitchByChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._AnimationManager.pitchBy", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let scaleByChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._AnimationManager.scaleBy", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let moveByChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._AnimationManager.moveBy", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let rotateByChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._AnimationManager.rotateBy", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let cancelCameraAnimationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._AnimationManager.cancelCameraAnimation", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class _CameraManagerSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _CameraManager?) {
    /// Convenience method that returns a `camera options` object for the given parameters.
    ///
    /// @param coordinates The `coordinates` representing the bounds of the camera.
    /// @param camera The `camera options` which will be applied before calculating the camera for the coordinates.
    ...
    /// @param offset The center of the given bounds relative to map center in screen points.
    /// @return The `camera options` object representing the provided parameters.
    let cameraForCoordinatesPaddingChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._CameraManager.cameraForCoordinatesPadding", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param offset The center of the given bounds relative to map center in screen points.
    /// @return The `camera options` object representing the provided parameters.
    let cameraForCoordinateBoundsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._CameraManager.cameraForCoordinateBounds", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The `camera options` object representing the provided parameters.
    let cameraForCoordinatesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._CameraManager.cameraForCoordinates", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The `camera options` object with the zoom level adjusted to fit `coordinates` into the `box`.
    let cameraForCoordinatesCameraOptionsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._CameraManager.cameraForCoordinatesCameraOptions", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The `camera options` object representing the provided parameters.
    let cameraForGeometryChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._CameraManager.cameraForGeometry", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @return The `coordinate bounds` object representing a given `camera`.
    ///
    let coordinateBoundsForCameraChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._CameraManager.coordinateBoundsForCamera", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @return The `coordinate bounds` object representing a given `camera`.
    ///
    let coordinateBoundsForCameraUnwrappedChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._CameraManager.coordinateBoundsForCameraUnwrapped", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @return The object representing `coordinate bounds` and `zoom` for a given `camera`.
    ///
    let coordinateBoundsZoomForCameraChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._CameraManager.coordinateBoundsZoomForCamera", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @return The object representing `coordinate bounds` and `zoom` for a given `camera`.
    ///
    let coordinateBoundsZoomForCameraUnwrappedChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._CameraManager.coordinateBoundsZoomForCameraUnwrapped", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A `screen coordinate` on the screen in `logical pixels`.
    let pixelForCoordinateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._CameraManager.pixelForCoordinate", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A geographical `coordinate` corresponding to a given `screen coordinate`.
    let coordinateForPixelChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._CameraManager.coordinateForPixel", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A `screen coordinates` in `logical pixels` for a given geographical `coordinates`.
    let pixelsForCoordinatesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._CameraManager.pixelsForCoordinates", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A `geographical coordinates` that correspond to a given `screen coordinates`.
    let coordinatesForPixelsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._CameraManager.coordinatesForPixels", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param cameraOptions The new `camera options` to be set.
    let setCameraChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._CameraManager.setCamera", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The current `camera state`.
    let getCameraStateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._CameraManager.getCameraState", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param options The `camera bounds options` to set.
    /// @return A string describing an error if the operation was not successful, expected with `void` value otherwise.
    let setBoundsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._CameraManager.setBounds", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the `camera bounds` of the map.
    /// @return A `camera bounds` of the map.
    let getBoundsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._CameraManager.getBounds", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class _MapInterfaceSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _MapInterface?) {
    let loadStyleURIChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.loadStyleURI", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let loadStyleJsonChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.loadStyleJson", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let clearDataChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.clearData", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setTileCacheBudgetChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.setTileCacheBudget", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The `size` of the map in `logical pixels`.
    let getSizeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.getSize", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Triggers a repaint of the map.
    let triggerRepaintChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.triggerRepaint", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param inProgress The `boolean` value representing if a gesture is in progress.
    let setGestureInProgressChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.setGestureInProgress", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return `true` if a gesture is currently in progress, `false` otherwise.
    let isGestureInProgressChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.isGestureInProgress", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param inProgress The `boolean` value representing if user animation is in progress
    let setUserAnimationInProgressChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.setUserAnimationInProgress", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return `true` if a user animation is currently in progress, `false` otherwise.
    let isUserAnimationInProgressChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.isUserAnimationInProgress", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param delta The new prefetch zoom delta.
    let setPrefetchZoomDeltaChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.setPrefetchZoomDelta", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The map's prefetch zoom `delta`.
    let getPrefetchZoomDeltaChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.getPrefetchZoomDelta", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Sets the north `orientation mode`.
    let setNorthOrientationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.setNorthOrientation", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Sets the map `constrain mode`.
    let setConstrainModeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.setConstrainMode", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Sets the `viewport mode`.
    let setViewportModeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.setViewportMode", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The map's `map options`.
    let getMapOptionsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.getMapOptions", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return An array of `map debug options` flags currently set to the map.
    let getDebugChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.getDebug", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param value A `boolean` value representing the state for a given `map debug options`.
    ///
    let setDebugChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.setDebug", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param completion The `query features completion` called when the query completes.
    /// @return A `cancelable` object that could be used to cancel the pending query.
    let queryRenderedFeaturesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.queryRenderedFeatures", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param options The `source query options` for querying source features.
    /// @param completion The `query features completion` called when the query completes.
    let querySourceFeaturesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.querySourceFeatures", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param completion The result will be returned through the completion block.
    ///         The result is a feature collection or a string describing an error if the operation was not successful.
    let getGeoJsonClusterLeavesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.getGeoJsonClusterLeaves", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param completion The result will be returned through the completion block.
    ///         The result is a feature collection or a string describing an error if the operation was not successful.
    let getGeoJsonClusterChildrenChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.getGeoJsonClusterChildren", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param completion The result will be returned through the completion block.
    ///         The result is a feature extension value containing a value or a string describing an error if the operation was not successful.
    let getGeoJsonClusterExpansionZoomChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.getGeoJsonClusterExpansionZoom", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param featureId The feature identifier of the feature whose state should be updated.
    /// @param state The `state` object with properties to update with their respective new values.
    let setFeatureStateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.setFeatureState", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param featureId The feature identifier of the feature whose state should be queried.
    /// @param completion The `query feature state completion` called when the query completes.
    let getFeatureStateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.getFeatureState", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param featureId The feature identifier of the feature whose state should be removed.
    /// @param stateKey The key of the property to remove. If `null`, all feature's state object properties are removed.
    let removeFeatureStateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.removeFeatureState", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Reduces memory use. Useful to call when the application gets paused or sent to background.
    let reduceMemoryUseChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.reduceMemoryUse", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param coordinate The `coordinate` defined as longitude-latitude pair.
    /// @return The elevation (in meters) multiplied by current terrain exaggeration, or empty if elevation for the coordinate is not available.
    let getElevationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.getElevation", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class OfflineRegionSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: OfflineRegion?) {
    /// The regions identifier
    let getIdentifierChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.OfflineRegion.getIdentifier", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A definition describing the tile pyramid including attributes, otherwise empty.
    let getTilePyramidDefinitionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.OfflineRegion.getTilePyramidDefinition", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A definition describing the geometry including attributes, otherwise empty.
    let getGeometryDefinitionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.OfflineRegion.getGeometryDefinition", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The metadata associated with the region.
    let getMetadataChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.OfflineRegion.getMetadata", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param metadata The metadata associated with the region.
    /// @param callback Called once the request is complete or an error occurred.
    let setMetadataChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.OfflineRegion.setMetadata", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param state The new state to set.
    let setOfflineRegionDownloadStateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.OfflineRegion.setOfflineRegionDownloadState", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param callback Called once the request is complete or an error occurred.
    let invalidateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.OfflineRegion.invalidate", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param callback Called once the request is complete or an error occurred.
    let purgeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.OfflineRegion.purge", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class OfflineRegionManagerSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: OfflineRegionManager?) {
    /// Sets the maximum number of Mapbox-hosted tiles that may be downloaded and stored on the current device.
    ///
    /// By default, the limit is set to 6,000.
    /// Once this limit is reached, `OfflineRegionObserver.mapboxTileCountLimitExceeded()`
    ...
    ///
    /// @param limit the maximum number of tiles allowed to be downloaded
    let setOfflineMapboxTileCountLimitChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.OfflineRegionManager.setOfflineMapboxTileCountLimit", binaryMessenger: binaryMessenger)
    if let api = api {
...
class ProjectionSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: Projection?) {
    /// Calculate distance spanned by one pixel at the specified latitude
    /// and zoom level.
    ///
    /// @param latitude The latitude for which to return the value.
    ...
    ///
    /// @return Returns the distance measured in meters.
    let getMetersPerPixelAtLatitudeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.Projection.getMetersPerPixelAtLatitude", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return Returns Spherical Mercator ProjectedMeters coordinates.
    let projectedMetersForCoordinateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.Projection.projectedMetersForCoordinate", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return Returns a longitude-latitude pair.
    let coordinateForProjectedMetersChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.Projection.coordinateForProjectedMeters", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return Returns a point on the map in Mercator projection.
    let projectChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.Projection.project", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return Returns a coordinate.
    let unprojectChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.Projection.unproject", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class _MapboxOptionsSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _MapboxOptions?) {
    let getAccessTokenChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapboxOptions.getAccessToken", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let setAccessTokenChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapboxOptions.setAccessToken", binaryMessenger: binaryMessenger)
    if let api = api {
...
class _MapboxMapsOptionsSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _MapboxMapsOptions?) {
    let getBaseUrlChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapboxMapsOptions.getBaseUrl", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let setBaseUrlChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapboxMapsOptions.setBaseUrl", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let getDataPathChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapboxMapsOptions.getDataPath", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let setDataPathChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapboxMapsOptions.setDataPath", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let getAssetPathChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapboxMapsOptions.getAssetPath", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let setAssetPathChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapboxMapsOptions.setAssetPath", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let getTileStoreUsageModeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapboxMapsOptions.getTileStoreUsageMode", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let setTileStoreUsageModeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter._MapboxMapsOptions.setTileStoreUsageMode", binaryMessenger: binaryMessenger)
    if let api = api {
...
class SettingsSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: Settings?) {
    /// Sets setting value for a specified key.
    ///
    /// @param key A name of the key.
    /// @param value The `value` for the key.
    let setChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.Settings.set", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    ///
    /// @return `value` if a key exists in settings otherwise a `null value` will be returned.
    let getChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.Settings.get", binaryMessenger: binaryMessenger)
    if let api = api {
...
class MapSnapshotSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: MapSnapshot?) {
    /// Calculate screen coordinate on the snapshot from geographical `coordinate`.
    ///
    /// @param coordinate A geographical `coordinate`.
    /// @return A `screen coordinate` measured in `logical pixels` on the snapshot for geographical `coordinate`.
    let screenCoordinateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.MapSnapshot.screenCoordinate", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param screenCoordinate A `screen coordinate` on the snapshot in `logical pixels`.
    /// @return A geographical `coordinate` for a `screen coordinate` on the snapshot.
    let coordinateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.MapSnapshot.coordinate", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A list of attributions for the sources in this snapshot.
    let attributionsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.MapSnapshot.attributions", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A rendered snapshot `image`.
    let imageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.MapSnapshot.image", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class MapSnapshotterSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: MapSnapshotter?) {
    /// Sets the `size` of the snapshot
    ///
    /// @param size The new `size` of the snapshot in `logical pixels`.
    let setSizeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.MapSnapshotter.setSize", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return Snapshot `size` in `logical pixels`.
    let getSizeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.MapSnapshotter.getSize", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getSizeChannel.setMessageHandler { _, reply in
        do {
          let result = try api.getSize()
    ...
    ///
    /// @return `true` if the snapshotter is in the tile mode, `false` otherwise.
    let isInTileModeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.MapSnapshotter.isInTileMode", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param set A `boolean` value representing if the snapshotter is in the tile mode.
    let setTileModeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.MapSnapshotter.setTileMode", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Cancel the current snapshot operation, if any. The callback passed to the start method
    /// is called with error parameter set.
    let cancelChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.MapSnapshotter.cancel", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return Elevation (in meters) multiplied by current terrain exaggeration, or empty if elevation for the coordinate is not available.
    let getElevationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.MapSnapshotter.getElevation", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getElevationChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let coordinateArg = args[0] as! [String?: Any?]
...
class StyleManagerSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: StyleManager?) {
    /// Get the URI of the current style in use.
    ///
    /// @return A string containing a style URI.
    let getStyleURIChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.getStyleURI", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param uri URI where the style should be loaded from.
    let setStyleURIChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.setStyleURI", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A JSON string containing a serialized style.
    let getStyleJSONChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.getStyleJSON", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param json A JSON string containing a serialized style.
    let setStyleJSONChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.setStyleJSON", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The default `camera options` of the current style in use.
    let getStyleDefaultCameraChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.getStyleDefaultCamera", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The `transition options` of the current style in use.
    let getStyleTransitionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.getStyleTransition", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the list containing information about existing style import objects.
    let getStyleImportsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.getStyleImports", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param importId Identifier of the style import to remove.
    let removeStyleImportChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.removeStyleImport", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// Returns the style import schema, containing the default configurations for the style import.
    let getStyleImportSchemaChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.getStyleImportSchema", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// Returns the style import configuration or a string describing an error if the operation was not successful.
    let getStyleImportConfigPropertiesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.getStyleImportConfigProperties", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// Returns the style import configuration or a string describing an error if the operation was not successful.
    let getStyleImportConfigPropertyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.getStyleImportConfigProperty", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param importId Identifier of the style import.
    /// @param configs A map of style import configurations.
    let setStyleImportConfigPropertiesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.setStyleImportConfigProperties", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param config The style import config name.
    /// @param value The style import config value.
    let setStyleImportConfigPropertyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.setStyleImportConfigProperty", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param transitionOptions The `transition options`.
    let setStyleTransitionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.setStyleTransition", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, or empty otherwise.
    let addStyleLayerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.addStyleLayer", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, or empty otherwise.
    let addPersistentStyleLayerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.addPersistentStyleLayer", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param layerId A style layer identifier.
    /// @return A string describing an error if the operation was not successful, boolean representing state otherwise.
    let isStyleLayerPersistentChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.isStyleLayerPersistent", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, or empty otherwise.
    let removeStyleLayerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.removeStyleLayer", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, or empty otherwise.
    let moveStyleLayerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.moveStyleLayer", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A `true` value if the given style layer exists, `false` otherwise.
    let styleLayerExistsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.styleLayerExists", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The list containing the information about existing style layer objects.
    let getStyleLayersChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.getStyleLayers", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param property The style layer property name.
    /// @return The `style property value`.
    let getStyleLayerPropertyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.getStyleLayerProperty", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let setStyleLayerPropertyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.setStyleLayerProperty", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The style layer properties or a string describing an error if the operation was not successful.
    let getStyleLayerPropertiesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.getStyleLayerProperties", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let setStyleLayerPropertiesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.setStyleLayerProperties", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let addStyleSourceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.addStyleSource", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param property The style source property name.
    /// @return The value of a `property` in the source with a `sourceId`.
    let getStyleSourcePropertyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.getStyleSourceProperty", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let setStyleSourcePropertyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.setStyleSourceProperty", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The style source properties or a string describing an error if the operation was not successful.
    let getStyleSourcePropertiesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.getStyleSourceProperties", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let setStyleSourcePropertiesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.setStyleSourceProperties", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let updateStyleImageSourceImageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.updateStyleImageSourceImage", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param sourceId An identifier of the style source to remove.
    let removeStyleSourceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.removeStyleSource", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return `true` if the given source exists, `false` otherwise.
    let styleSourceExistsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.styleSourceExists", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The list containing the information about existing style source objects.
    let getStyleSourcesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.getStyleSources", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns an ordered list of the current style lights.
    let getStyleLightsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.getStyleLights", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param flatLight The flat light source.
    let setLightChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.setLight", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param ambientLight The ambient light source.
    /// @param directionalLight The directional light source.
    let setLightsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.setLights", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param id The unique identifier of the style light in lights list.
    /// @return The style light property value.
    let getStyleLightPropertyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.getStyleLightProperty", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let setStyleLightPropertyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.setStyleLightProperty", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let setStyleTerrainChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.setStyleTerrain", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param property The style terrain property name.
    /// @return The style terrain property value.
    let getStyleTerrainPropertyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.getStyleTerrainProperty", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let setStyleTerrainPropertyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.setStyleTerrainProperty", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return The `image` for the given `imageId`, or empty if no image is associated with the `imageId`.
    let getStyleImageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.getStyleImage", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let addStyleImageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.addStyleImage", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let removeStyleImageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.removeStyleImage", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return True if image exists, false otherwise.
    let hasStyleImageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.hasStyleImage", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let invalidateStyleCustomGeometrySourceTileChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.invalidateStyleCustomGeometrySourceTile", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return A string describing an error if the operation was not successful, empty otherwise.
    let invalidateStyleCustomGeometrySourceRegionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.invalidateStyleCustomGeometrySourceRegion", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @return `true` iff the style JSON contents, the style specified sprite and sources are all loaded, otherwise returns `false`.
    ///
    let isStyleLoadedChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.isStyleLoaded", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @return Projection that is currently applied to the map
    let getProjectionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.getProjection", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    ///
    /// @param projection The projection to be set.
    let setProjectionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.setProjection", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// @param locale The locale to apply for localization
    /// @param layerIds The ids of layers that will localize on, default is null which means will localize all the feasible layers.
    let localizeLabelsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.StyleManager.localizeLabels", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class CancelableSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: Cancelable?) {
    /// Cancels the associated asynchronous operation
    ///
    /// If the associated asynchronous operation has already finished, this call is ignored.
    let cancelChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.Cancelable.cancel", binaryMessenger: binaryMessenger)
    if let api = api {
      cancelChannel.setMessageHandler { _, reply in
        do {
          try api.cancel()
...
class OfflineSwitchSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: OfflineSwitch?) {
    /// Connects or disconnects the Mapbox stack. If set to false, current and new HTTP requests will fail
    /// with HttpRequestErrorType#ConnectionError.
    ///
    /// @param connected Set false to disconnect the Mapbox stack
    let setMapboxStackConnectedChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.OfflineSwitch.setMapboxStackConnected", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    ///
    /// @return True if the Mapbox stack is disconnected via setMapboxStackConnected(), false otherwise.
    let isMapboxStackConnectedChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.OfflineSwitch.isMapboxStackConnected", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    /// Users can call this method if they want to do manual cleanup of the resources allocated by Mapbox services.
    /// If the user calls getInstance() after reset, a new instance of the OfflineSwitch singleton will be allocated.
    let resetChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter.OfflineSwitch.reset", binaryMessenger: binaryMessenger)
    if let api = api {
...
class TilesetDescriptorSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: TilesetDescriptor?) {
  }
}
