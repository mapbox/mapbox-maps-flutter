...
struct GlyphsRasterizationOptions {
  ...
  static func fromList(_ __pigeon_list: [Any?]) -> GlyphsRasterizationOptions? {
    let rasterizationMode = __pigeon_list[0] as! GlyphsRasterizationMode
    let fontFamily: String? = nilOrValue(__pigeon_list[1])
...
struct TileCoverOptions {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> TileCoverOptions? {
    let tileSize: Int64? = isNullish(__pigeon_list[0]) ? nil : (__pigeon_list[0] is Int64? ? __pigeon_list[0] as! Int64? : Int64(__pigeon_list[0] as! Int32))
    let minZoom: Int64? = isNullish(__pigeon_list[1]) ? nil : (__pigeon_list[1] is Int64? ? __pigeon_list[1] as! Int64? : Int64(__pigeon_list[1] as! Int32))
    let maxZoom: Int64? = isNullish(__pigeon_list[2]) ? nil : (__pigeon_list[2] is Int64? ? __pigeon_list[2] as! Int64? : Int64(__pigeon_list[2] as! Int32))
    let roundZoom: Bool? = nilOrValue(__pigeon_list[3])
...
struct MbxEdgeInsets {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> MbxEdgeInsets? {
    let top = __pigeon_list[0] as! Double
    let left = __pigeon_list[1] as! Double
    let bottom = __pigeon_list[2] as! Double
    let right = __pigeon_list[3] as! Double
...
struct CameraOptions {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> CameraOptions? {
    let center: Point? = nilOrValue(__pigeon_list[0])
    let padding: MbxEdgeInsets? = nilOrValue(__pigeon_list[1])
    let anchor: ScreenCoordinate? = nilOrValue(__pigeon_list[2])
    let zoom: Double? = nilOrValue(__pigeon_list[3])
    let bearing: Double? = nilOrValue(__pigeon_list[4])
    let pitch: Double? = nilOrValue(__pigeon_list[5])
...
struct CameraState {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> CameraState? {
    let center = __pigeon_list[0] as! Point
    let padding = __pigeon_list[1] as! MbxEdgeInsets
    let zoom = __pigeon_list[2] as! Double
    let bearing = __pigeon_list[3] as! Double
    let pitch = __pigeon_list[4] as! Double
...
struct CameraBoundsOptions {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> CameraBoundsOptions? {
    let bounds: CoordinateBounds? = nilOrValue(__pigeon_list[0])
    let maxZoom: Double? = nilOrValue(__pigeon_list[1])
    let minZoom: Double? = nilOrValue(__pigeon_list[2])
    let maxPitch: Double? = nilOrValue(__pigeon_list[3])
    let minPitch: Double? = nilOrValue(__pigeon_list[4])
...
struct CameraBounds {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> CameraBounds? {
    let bounds = __pigeon_list[0] as! CoordinateBounds
    let maxZoom = __pigeon_list[1] as! Double
    let minZoom = __pigeon_list[2] as! Double
    let maxPitch = __pigeon_list[3] as! Double
    let minPitch = __pigeon_list[4] as! Double
...
struct CoordinateBounds {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> CoordinateBounds? {
    let southwest = __pigeon_list[0] as! Point
    let northeast = __pigeon_list[1] as! Point
    let infiniteBounds = __pigeon_list[2] as! Bool
...
struct _MapWidgetDebugOptionsBox {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> _MapWidgetDebugOptionsBox? {
    let option = __pigeon_list[0] as! _MapWidgetDebugOptions
...
struct MapDebugOptions {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> MapDebugOptions? {
    let data = __pigeon_list[0] as! MapDebugOptionsData
...
struct TileCacheBudgetInMegabytes {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> TileCacheBudgetInMegabytes? {
    let size = __pigeon_list[0] is Int64 ? __pigeon_list[0] as! Int64 : Int64(__pigeon_list[0] as! Int32)
...
struct TileCacheBudgetInTiles {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> TileCacheBudgetInTiles? {
    let size = __pigeon_list[0] is Int64 ? __pigeon_list[0] as! Int64 : Int64(__pigeon_list[0] as! Int32)
...
struct MapOptions {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> MapOptions? {
    let contextMode: ContextMode? = nilOrValue(__pigeon_list[0])
    let constrainMode: ConstrainMode? = nilOrValue(__pigeon_list[1])
    let viewportMode: ViewportMode? = nilOrValue(__pigeon_list[2])
    let orientation: NorthOrientation? = nilOrValue(__pigeon_list[3])
    let crossSourceCollisions: Bool? = nilOrValue(__pigeon_list[4])
    let size: Size? = nilOrValue(__pigeon_list[5])
    let pixelRatio = __pigeon_list[6] as! Double
    let glyphsRasterizationOptions: GlyphsRasterizationOptions? = nilOrValue(__pigeon_list[7])
...
struct ScreenCoordinate {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> ScreenCoordinate? {
    let x = __pigeon_list[0] as! Double
    let y = __pigeon_list[1] as! Double
...
struct ScreenBox {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> ScreenBox? {
    let min = __pigeon_list[0] as! ScreenCoordinate
    let max = __pigeon_list[1] as! ScreenCoordinate
...
struct CoordinateBoundsZoom {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> CoordinateBoundsZoom? {
    let bounds = __pigeon_list[0] as! CoordinateBounds
    let zoom = __pigeon_list[1] as! Double
...
struct Size {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> Size? {
    let width = __pigeon_list[0] as! Double
    let height = __pigeon_list[1] as! Double
...
struct RenderedQueryOptions {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> RenderedQueryOptions? {
    let layerIds: [String?]? = nilOrValue(__pigeon_list[0])
    let filter: String? = nilOrValue(__pigeon_list[1])
...
struct SourceQueryOptions {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> SourceQueryOptions? {
    let sourceLayerIds: [String?]? = nilOrValue(__pigeon_list[0])
    let filter = __pigeon_list[1] as! String
...
struct FeatureExtensionValue {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> FeatureExtensionValue? {
    let value: String? = nilOrValue(__pigeon_list[0])
    let featureCollection: [[String?: Any?]?]? = nilOrValue(__pigeon_list[1])
...
struct LayerPosition {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> LayerPosition? {
    let above: String? = nilOrValue(__pigeon_list[0])
    let below: String? = nilOrValue(__pigeon_list[1])
    let at: Int64? = isNullish(__pigeon_list[2]) ? nil : (__pigeon_list[2] is Int64? ? __pigeon_list[2] as! Int64? : Int64(__pigeon_list[2] as! Int32))
...
struct QueriedRenderedFeature {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> QueriedRenderedFeature? {
    let queriedFeature = __pigeon_list[0] as! QueriedFeature
    let layers = __pigeon_list[1] as! [String?]
...
struct QueriedSourceFeature {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> QueriedSourceFeature? {
    let queriedFeature = __pigeon_list[0] as! QueriedFeature
...
struct QueriedFeature {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> QueriedFeature? {
    let feature = __pigeon_list[0] as! [String?: Any?]
    let source = __pigeon_list[1] as! String
    let sourceLayer: String? = nilOrValue(__pigeon_list[2])
    let state = __pigeon_list[3] as! String
...
struct ProjectedMeters {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> ProjectedMeters? {
    let northing = __pigeon_list[0] as! Double
    let easting = __pigeon_list[1] as! Double
...
struct MercatorCoordinate {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> MercatorCoordinate? {
    let x = __pigeon_list[0] as! Double
    let y = __pigeon_list[1] as! Double
...
struct StyleObjectInfo {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> StyleObjectInfo? {
    let id = __pigeon_list[0] as! String
    let type = __pigeon_list[1] as! String
...
struct StyleProjection {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> StyleProjection? {
    let name = __pigeon_list[0] as! StyleProjectionName
...
struct FlatLight {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> FlatLight? {
    let id = __pigeon_list[0] as! String
    let anchor: Anchor? = nilOrValue(__pigeon_list[1])
    let color: Int64? = isNullish(__pigeon_list[2]) ? nil : (__pigeon_list[2] is Int64? ? __pigeon_list[2] as! Int64? : Int64(__pigeon_list[2] as! Int32))
    let colorTransition: TransitionOptions? = nilOrValue(__pigeon_list[3])
    let intensity: Double? = nilOrValue(__pigeon_list[4])
    let intensityTransition: TransitionOptions? = nilOrValue(__pigeon_list[5])
    let position: [Double?]? = nilOrValue(__pigeon_list[6])
    let positionTransition: TransitionOptions? = nilOrValue(__pigeon_list[7])
...
struct DirectionalLight {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> DirectionalLight? {
    let id = __pigeon_list[0] as! String
    let castShadows: Bool? = nilOrValue(__pigeon_list[1])
    let color: Int64? = isNullish(__pigeon_list[2]) ? nil : (__pigeon_list[2] is Int64? ? __pigeon_list[2] as! Int64? : Int64(__pigeon_list[2] as! Int32))
    let colorTransition: TransitionOptions? = nilOrValue(__pigeon_list[3])
    let direction: [Double?]? = nilOrValue(__pigeon_list[4])
    let directionTransition: TransitionOptions? = nilOrValue(__pigeon_list[5])
    let intensity: Double? = nilOrValue(__pigeon_list[6])
    let intensityTransition: TransitionOptions? = nilOrValue(__pigeon_list[7])
    let shadowIntensity: Double? = nilOrValue(__pigeon_list[8])
    let shadowIntensityTransition: TransitionOptions? = nilOrValue(__pigeon_list[9])
...
struct AmbientLight {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> AmbientLight? {
    let id = __pigeon_list[0] as! String
    let color: Int64? = isNullish(__pigeon_list[1]) ? nil : (__pigeon_list[1] is Int64? ? __pigeon_list[1] as! Int64? : Int64(__pigeon_list[1] as! Int32))
    let colorTransition: TransitionOptions? = nilOrValue(__pigeon_list[2])
    let intensity: Double? = nilOrValue(__pigeon_list[3])
    let intensityTransition: TransitionOptions? = nilOrValue(__pigeon_list[4])
...
struct MbxImage {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> MbxImage? {
    let width = __pigeon_list[0] is Int64 ? __pigeon_list[0] as! Int64 : Int64(__pigeon_list[0] as! Int32)
    let height = __pigeon_list[1] is Int64 ? __pigeon_list[1] as! Int64 : Int64(__pigeon_list[1] as! Int32)
    let data = __pigeon_list[2] as! FlutterStandardTypedData
...
struct ImageStretches {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> ImageStretches? {
    let first = __pigeon_list[0] as! Double
    let second = __pigeon_list[1] as! Double
...
struct ImageContent {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> ImageContent? {
    let left = __pigeon_list[0] as! Double
    let top = __pigeon_list[1] as! Double
    let right = __pigeon_list[2] as! Double
    let bottom = __pigeon_list[3] as! Double
...
struct TransitionOptions {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> TransitionOptions? {
    let duration: Int64? = isNullish(__pigeon_list[0]) ? nil : (__pigeon_list[0] is Int64? ? __pigeon_list[0] as! Int64? : Int64(__pigeon_list[0] as! Int32))
    let delay: Int64? = isNullish(__pigeon_list[1]) ? nil : (__pigeon_list[1] is Int64? ? __pigeon_list[1] as! Int64? : Int64(__pigeon_list[1] as! Int32))
    let enablePlacementTransitions: Bool? = nilOrValue(__pigeon_list[2])
...
struct CanonicalTileID {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> CanonicalTileID? {
    let z = __pigeon_list[0] is Int64 ? __pigeon_list[0] as! Int64 : Int64(__pigeon_list[0] as! Int32)
    let x = __pigeon_list[1] is Int64 ? __pigeon_list[1] as! Int64 : Int64(__pigeon_list[1] as! Int32)
    let y = __pigeon_list[2] is Int64 ? __pigeon_list[2] as! Int64 : Int64(__pigeon_list[2] as! Int32)
...
struct StylePropertyValue {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> StylePropertyValue? {
    let value: Any? = __pigeon_list[0]
    let kind = __pigeon_list[1] as! StylePropertyValueKind
...
private class MapInterfacesPigeonCodecReader: FlutterStandardReader {
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 191:
      ...
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as? Int)
      if let enumResultAsInt = enumResultAsInt {
        enumResult = _MapEvent(rawValue: enumResultAsInt)
      }
      return enumResult
    default:
