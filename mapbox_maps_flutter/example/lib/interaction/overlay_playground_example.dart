...
class _OverlayPlaygroundExampleState extends State<OverlayPlaygroundExample> {
  ...
  void _onMapCreated(MapboxMap map) {
    applyCatalogOrnamentDefaults(context, map);
    map.addInteraction(
  ...
  Widget _buildTestZone() {
    ...
    return Positioned.fill(
      child: Stack(
        children: [
          // Centred, so the panel stays reachable.
          Positioned(
            left: 380,
            right: 120,
            top: 96,
...
class _FrostedCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Matches the other floating map panels in the app.
    return ClipRRect(
      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          // SwitchListTile and ink splashes need a Material ancestor, and
          // transparency keeps the frosted background visible.
