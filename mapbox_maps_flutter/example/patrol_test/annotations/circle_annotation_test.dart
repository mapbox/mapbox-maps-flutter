...
void main() {
  ...
  patrolTest('create CircleAnnotation', skip: kIsWeb, ($) async {
    final tester = $.tester;
  ...
  patrolTest('update and delete CircleAnnotation', skip: kIsWeb, ($) async {
    final tester = $.tester;
    final mapboxMap = await app.pumpMap(tester: $.tester);
    await tester.pumpAndSettle();
    final manager = await mapboxMap.annotations.createCircleAnnotationManager();
  ...
  patrolTest('deleteMulti CircleAnnotation', skip: kIsWeb, ($) async {
    final tester = $.tester;
    final mapboxMap = await app.pumpMap(tester: $.tester);
    await tester.pumpAndSettle();
    final manager = await mapboxMap.annotations.createCircleAnnotationManager();
