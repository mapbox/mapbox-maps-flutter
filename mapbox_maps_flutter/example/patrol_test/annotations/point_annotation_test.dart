...
void main() {
  ...
  patrolTest('create PointAnnotation', skip: kIsWeb, ($) async {
    final tester = $.tester;
  ...
  patrolTest('update and delete PointAnnotation', skip: kIsWeb, ($) async {
    final tester = $.tester;
    final mapboxMap = await app.pumpMap(tester: $.tester);
    await tester.pumpAndSettle();
    final manager = await mapboxMap.annotations.createPointAnnotationManager();
  ...
  patrolTest('deleteMulti PointAnnotation', skip: kIsWeb, ($) async {
    final tester = $.tester;
    final mapboxMap = await app.pumpMap(tester: $.tester);
    await tester.pumpAndSettle();
    final manager = await mapboxMap.annotations.createPointAnnotationManager();
