...
void main() {
  ...
  patrolTest('Basic snapshot', skip: kIsWeb, ($) async {
    final tester = $.tester;
  ...
  patrolTest('Snapshotter style loaded', skip: kIsWeb, ($) async {
    final tester = $.tester;
    await app.runEmpty($.tester);
    await tester.pumpAndSettle();
  ...
  patrolTest('Snapshotter runtime configuration', skip: kIsWeb, ($) async {
    final tester = $.tester;
    await app.runEmpty($.tester);
    await tester.pumpAndSettle();
  ...
  patrolTest('Snapshotter cancel and clear', skip: kIsWeb, ($) async {
    final tester = $.tester;
    await app.runEmpty($.tester);
    await tester.pumpAndSettle();
