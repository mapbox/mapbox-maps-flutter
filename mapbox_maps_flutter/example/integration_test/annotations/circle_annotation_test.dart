...
void main() {
  ...
  testWidgets('create CircleAnnotation', skip: kIsWeb, (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('update and delete CircleAnnotation', skip: kIsWeb, (
    WidgetTester tester,
  ) async {
    final mapFuture = app.main();
    await tester.pumpAndSettle();
  ...
  testWidgets('deleteMulti CircleAnnotation', skip: kIsWeb, (
    WidgetTester tester,
  ) async {
    final mapFuture = app.main();
    await tester.pumpAndSettle();
