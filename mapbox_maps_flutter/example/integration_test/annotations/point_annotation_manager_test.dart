...
void main() {
  ...
  testWidgets('PointAnnotationManager custom id and position', skip: kIsWeb, (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('create PointAnnotation_manager ', skip: kIsWeb, (
    WidgetTester tester,
  ) async {
    final mapFuture = app.main();
    await tester.pumpAndSettle();
    ...
    await manager.setIconSizeScaleRange([5.0, 5.0]);
    var iconSizeScaleRange = await manager.getIconSizeScaleRange();
    expect([5.0, 5.0], iconSizeScaleRange);
    ...
    await manager.setTextSizeScaleRange([5.0, 5.0]);
  ...
  group('annotation events', () {
    late _FakePointAnnotationManagerPI fake;
    late PointAnnotationManager manager;

    setUp(() {
      fake = _FakePointAnnotationManagerPI();
      // ignore: invalid_use_of_internal_member
      manager = PointAnnotationManager(fake);
    });
