...
void main() {
  ...
  testWidgets('Add RasterDemSource', skip: kIsWeb, (WidgetTester tester) async {
    ...
    var maxOverscaleFactorForParentTiles = await source.maxOverscaleFactorForParentTiles;
