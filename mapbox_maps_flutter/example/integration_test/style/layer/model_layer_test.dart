...
void main() {
  ...
  testWidgets('Add ModelLayer', skip: kIsWeb, (WidgetTester tester) async {
    ...
    expect(layer.modelHeightBasedEmissiveStrengthMultiplier,  [0.0, 1.0, 2.0, 3.0, 4.0]);
...
testWidgets('Add ModelLayer with expressions', skip: kIsWeb, (WidgetTester tester) async {
    final mapFuture = app.main();
    await tester.pumpAndSettle();
    final mapboxMap = await mapFuture;
    ...
    modelHeightBasedEmissiveStrengthMultiplierExpression: ['literal', [0.0, 1.0, 2.0, 3.0, 4.0]],
    modelOpacityExpression: ['number', 1.0],
    modelReceiveShadowsExpression: ['==', true, true],
    modelRotationExpression: ['literal', [0.0, 1.0, 2.0]],
    modelRoughnessExpression: ['number', 1.0],
    modelScaleExpression: ['literal', [0.0, 1.0, 2.0]],
    modelScaleModeExpression: ['string', 'map'],
    modelTranslationExpression: ['literal', [0.0, 1.0, 2.0]],
