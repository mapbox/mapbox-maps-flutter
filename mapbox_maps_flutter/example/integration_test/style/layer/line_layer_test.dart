...
testWidgets('Add LineLayer with expressions', skip: kIsWeb, (WidgetTester tester) async {
    final mapFuture = app.main();
    await tester.pumpAndSettle();
    final mapboxMap = await mapFuture;
    ...
    lineDasharrayExpression: ['literal', [1.0, 2.0]],
    ...
    lineTranslateExpression: ['literal', [0.0, 1.0]],
    lineTranslateAnchorExpression: ['string', 'map'],
    lineTrimColorExpression: ['rgba', 255, 0, 0, 1],
    lineTrimFadeRangeExpression: ['literal', [0.5, 0.5]],
    lineTrimOffsetExpression: ['literal', [0.5, 0.5]],
