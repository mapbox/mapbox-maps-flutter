...
testWidgets('Add RasterLayer with expressions', skip: kIsWeb, (WidgetTester tester) async {
    final mapFuture = app.main();
    await tester.pumpAndSettle();
    final mapboxMap = await mapFuture;
    ...
    rasterColorMixExpression: ['literal', [0.0, 1.0, 2.0, 3.0]],
    rasterColorRangeExpression: ['literal', [0.0, 1.0]],
