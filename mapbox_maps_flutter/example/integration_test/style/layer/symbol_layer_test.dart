...
void main() {
  ...
  testWidgets('Add SymbolLayer', skip: kIsWeb, (WidgetTester tester) async {
    ...
    expect(layer.iconSizeScaleRange,  [5.0, 5.0]);
    ...
    expect(layer.textSizeScaleRange,  [5.0, 5.0]);
...
testWidgets('Add SymbolLayer with expressions', skip: kIsWeb, (WidgetTester tester) async {
    final mapFuture = app.main();
    await tester.pumpAndSettle();
    final mapboxMap = await mapFuture;
    ...
    iconOffsetExpression: ['literal', [0.0, 1.0]],
    ...
    iconSizeScaleRangeExpression: ['literal', [5.0, 5.0]],
    iconTextFitExpression: ['string', 'none'],
    iconTextFitPaddingExpression: ['literal', [0.0, 1.0, 2.0, 3.0]],
    ...
    textFontExpression: ['literal', ["a", "b", "c"]],
    ...
    textOffsetExpression: ['literal', [0.0, 1.0]],
    ...
    textSizeScaleRangeExpression: ['literal', [5.0, 5.0]],
    textTransformExpression: ['string', 'none'],
    textVariableAnchorExpression: ['literal', ["center", "left"]],
    textWritingModeExpression: ['literal', ["horizontal", "vertical"]],
    ...
    iconTranslateExpression: ['literal', [0.0, 1.0]],
    ...
    textTranslateExpression: ['literal', [0.0, 1.0]],
    ...
    expect(layer.slot, LayerSlot.BOTTOM);
    expect(layer.visibility, Visibility.NONE);
    expect(layer.filter, ["==", ["get", "type"], "Feature"]);
    expect(layer.iconAllowOverlap,  true);
    expect(layer.iconAnchor,  IconAnchor.CENTER);
    expect(layer.iconIgnorePlacement,  true);
