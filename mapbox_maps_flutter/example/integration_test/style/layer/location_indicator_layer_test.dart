...
void main() {
  ...
  testWidgets('Add LocationIndicatorLayer', skip: kIsWeb, (WidgetTester tester) async {
...
testWidgets('Add LocationIndicatorLayer with expressions', skip: kIsWeb, (WidgetTester tester) async {
    final mapFuture = app.main();
    await tester.pumpAndSettle();
    final mapboxMap = await mapFuture;
    ...
    emphasisCircleGlowRangeExpression: ['literal', [0.0, 1.0]],
    emphasisCircleRadiusExpression: ['number', 1.0],
    imagePitchDisplacementExpression: ['number', 1.0],
    locationExpression: ['literal', [0.0, 1.0, 2.0]],
