...
void main() {
  ...
  testWidgets('Add FillExtrusionLayer', skip: kIsWeb, (WidgetTester tester) async {
    ...
    expect(layer.fillExtrusionBaseAlignment,  FillExtrusionBaseAlignment.TERRAIN);
    ...
    expect(layer.fillExtrusionHeightAlignment,  FillExtrusionHeightAlignment.TERRAIN);
...
testWidgets('Add FillExtrusionLayer with expressions', skip: kIsWeb, (WidgetTester tester) async {
    final mapFuture = app.main();
    await tester.pumpAndSettle();
    final mapboxMap = await mapFuture;
    ...
    fillExtrusionTranslateExpression: ['literal', [0.0, 1.0]],
    ...
    expect(layer.fillExtrusionCutoffFadeRange,  1.0);
    expect(layer.fillExtrusionEmissiveStrength,  1.0);
    expect(layer.fillExtrusionFloodLightColorExpression,  ['rgba', 255, 0, 0, 1]);
    expect(layer.fillExtrusionFloodLightGroundAttenuation,  1.0);
    expect(layer.fillExtrusionFloodLightGroundRadius,  1.0);
    expect(layer.fillExtrusionFloodLightIntensity,  1.0);
    expect(layer.fillExtrusionFloodLightWallRadius,  1.0);
