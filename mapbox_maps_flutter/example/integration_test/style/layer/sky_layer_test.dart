...
testWidgets('Add SkyLayer with expressions', skip: kIsWeb, (WidgetTester tester) async {
    final mapFuture = app.main();
    await tester.pumpAndSettle();
    final mapboxMap = await mapFuture;
    ...
    skyAtmosphereSunExpression: ['literal', [180.0, 90.0]],
    skyAtmosphereSunIntensityExpression: ['number', 1.0],
    skyGradientExpression: ['rgba', 255, 0, 0, 1],
    skyGradientCenterExpression: ['literal', [180.0, 90.0]],
