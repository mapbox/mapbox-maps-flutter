...
final class RasterParticleLayer extends Layer {
  ...
  static RasterParticleLayer decode(String properties) {
    ...
    return RasterParticleLayer(
      ...
      rasterParticleArrayBand: styleOptionalCast(
        map["paint"]["raster-particle-array-band"],
      ),
      rasterParticleArrayBandExpression: styleOptionalCastList(
        map["paint"]["raster-particle-array-band"],
      ),
      rasterParticleColor: (map["paint"]["raster-particle-color"] as List?)
          ?.toRGBAInt(),
      rasterParticleColorExpression: styleOptionalCastList(
        map["paint"]["raster-particle-color"],
      ),
      rasterParticleCount: styleOptionalCast(
        map["paint"]["raster-particle-count"],
      ),
      rasterParticleCountExpression: styleOptionalCastList(
        map["paint"]["raster-particle-count"],
      ),
      rasterParticleFadeOpacityFactor: styleOptionalCast(
        map["paint"]["raster-particle-fade-opacity-factor"],
      ),
      rasterParticleFadeOpacityFactorExpression: styleOptionalCastList(
        map["paint"]["raster-particle-fade-opacity-factor"],
      ),
      rasterParticleMaxSpeed: styleOptionalCast(
        map["paint"]["raster-particle-max-speed"],
      ),
      rasterParticleMaxSpeedExpression: styleOptionalCastList(
        map["paint"]["raster-particle-max-speed"],
      ),
      rasterParticleResetRateFactor: styleOptionalCast(
        map["paint"]["raster-particle-reset-rate-factor"],
      ),
      rasterParticleResetRateFactorExpression: styleOptionalCastList(
        map["paint"]["raster-particle-reset-rate-factor"],
      ),
      rasterParticleSpeedFactor: styleOptionalCast(
        map["paint"]["raster-particle-speed-factor"],
      ),
      rasterParticleSpeedFactorExpression: styleOptionalCastList(
        map["paint"]["raster-particle-speed-factor"],
      ),
    );
  }
