...
void main() {
  ...
  test('MapIdleEventData fromJson', () {
    var mapIdleEventData = MapIdleEventData.fromJson(<String, dynamic>{
      'timestamp': 1,
    });
  ...
  test('RenderFrameFinishedEventData fromJson', () {
    var renderFrameFinishedEventData = RenderFrameFinishedEventData.fromJson(
      <String, dynamic>{
        'timeInterval': <String, dynamic>{'begin': 1, 'end': 2},
        'renderMode': 1,
    ...
    expect(
      renderFrameFinishedEventData.timeInterval.end.microsecondsSinceEpoch,
      2,
    );
  ...
  test('ResourceEventData fromJson', () {
    ...
    expect(
      resourceEventData.response!.eTag,
    ...
    expect(
      resourceEventData.response!.error!.reason,
  ...
  test('SourceAddedEventData fromJson', () {
    var sourceAddedEventData = SourceAddedEventData.fromJson(<String, dynamic>{
      'timestamp': 1,
      'sourceId': 'id',
    });
  ...
  test('SourceDataLoadedEventData fromJson', () {
    var sourceDataLoadedEventData = SourceDataLoadedEventData.fromJson(
      <String, dynamic>{
        'timeInterval': <String, dynamic>{'begin': 1, 'end': 2},
        'sourceId': 'id',
        'type': 1,
    ...
    expect(
      sourceDataLoadedEventData.timeInterval.begin.microsecondsSinceEpoch,
      1,
    );
    expect(
      sourceDataLoadedEventData.timeInterval.end.microsecondsSinceEpoch,
      2,
    );
  ...
  test('StyleDataLoadedEventData fromJson', () {
    ...
    expect(
      styleDataLoadedEventData.timeInterval.begin.microsecondsSinceEpoch,
      1,
    );
