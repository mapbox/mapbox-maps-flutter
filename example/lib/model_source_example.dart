...
class ModelSourceExample extends StatefulWidget implements Example {
  @override
  final Widget leading = const Icon(Icons.view_in_ar);
  @override
  final String title = 'Display multiple 3D models with a ModelSource';
  @override
  final String subtitle = 'Showcase the usage of the ModelSource API.';
    ...
    await mapboxMap.style.addSource(
      ModelSource(
        ...
        models: [
          ModelSourceModel(
            id: 'car-default',
            uri: _ModelSourceExampleState._carUri,
            position: _position(-0.00018, 0),
            orientation: [0.0, 0.0, 90.0],
            featureProperties: {
              _ModelSourceExampleState._modelScaleKey: [1.0, 1.0, 1.0]
            },
          ),
          ModelSourceModel(
            id: 'car-tinted',
          ...
          ModelSourceModel(
            ...
            orientation: [0.0, 0.0, 90.0],
            featureProperties: {
              _ModelSourceExampleState._modelScaleKey: [2.0, 2.0, 2.0]
            },
          ),
          ModelSourceModel(
            id: 'buggy',
            uri: _ModelSourceExampleState._buggyUri,
            position: _position(0, 0.00015),
            orientation: [0.0, 0.0, 90.0],
            featureProperties: {
              _ModelSourceExampleState._modelScaleKey: [0.05, 0.05, 0.05]
            },
          ),
        ],
      ),
    ...
    await mapboxMap.style.addLayer(
      ModelLayer(
        ...
        modelScaleExpression: [
          'get',
          _modelScaleKey
        ], // per-model scale, driven by featureProperties below
      ),
    );
  }
