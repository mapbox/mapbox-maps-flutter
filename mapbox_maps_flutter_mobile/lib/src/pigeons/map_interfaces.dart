...
class _InteractionPigeon {
  ...
  bool operator ==(Object other) {
    if (other is! _InteractionPigeon || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
    }
    return _deepEquals(featuresetDescriptor, other.featuresetDescriptor) &&
...
class _RenderedQueryGeometry {
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! _RenderedQueryGeometry || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class _MapInterfacesPigeonCodec extends StandardMessageCodec {
  const _MapInterfacesPigeonCodec();
  @override
...
class _MapInterface {
  ...
  Future<Uint8List?> snapshot() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.snapshot$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
