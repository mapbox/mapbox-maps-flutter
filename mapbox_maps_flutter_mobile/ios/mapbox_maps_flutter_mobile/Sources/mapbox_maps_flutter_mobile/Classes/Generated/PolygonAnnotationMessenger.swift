...
struct PolygonAnnotation {
  ...
  /// Default value: "rgba(241, 236, 225, 255)".
  /// @experimental
  var fillTunnelStructureColor: Int64?
...
class _PolygonAnnotationMessengerSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: _PolygonAnnotationMessenger?, messageChannelSuffix: String = "") {
    ...
    let setFillConstructBridgeGuardRailChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter_mobile._PolygonAnnotationMessenger.setFillConstructBridgeGuardRail\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setFillBridgeGuardRailColorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter_mobile._PolygonAnnotationMessenger.setFillBridgeGuardRailColor\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setFillTunnelStructureColorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mapbox_maps_flutter_mobile._PolygonAnnotationMessenger.setFillTunnelStructureColor\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
