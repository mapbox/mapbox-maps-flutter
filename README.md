...
The Mapbox Maps SDK Flutter SDK is an officially developed solution from Mapbox that enables use of our latest Maps SDK product (v11.26.0-rc.1-SNAPSHOT-07-01--06-54.git-25b0d54). The SDK allows developers to embed highly-customized maps using a Flutter widget on Android and iOS.

Web support is now in Public Preview through 3.0.0-alpha.1, see [installation guide](https://docs.mapbox.com/flutter/maps/guides/install-v3/).
