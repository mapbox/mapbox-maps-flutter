...
class PolylineAnnotationManager extends BaseAnnotationManager {
  PolylineAnnotationManager({required String id, required BinaryMessenger messenger}) : super(id: id, messenger: messenger);

  late _PolylineAnnotationMessager messager = _PolylineAnnotationMessager(binaryMessenger: _messenger);

  /// Add a listener to receive the callback when an annotation is clicked.
  void addOnPolylineAnnotationClickListener(OnPolylineAnnotationClickListener listener) {
  ...
  Future<List<PolylineAnnotation?>> createMulti(List<PolylineAnnotationOptions> annotations) =>
      messager.createMulti(id, annotations);

  /// Update an added annotation with new properties.
  Future<void> update(PolylineAnnotation annotation) => messager.update(id, annotation);

  /// Delete an added annotation.
  Future<void> delete(PolylineAnnotation annotation) => messager.delete(id, annotation);
  ...
  Future<void> setLineCap(LineCap lineCap)
    => messager.setLineCap(id, lineCap);

  /// The display of line endings.
  Future<LineCap?> getLineCap()
    => messager.getLineCap(id).then((value) => value != null ? LineCap.values[value] : null);
  ...
  Future<LineTranslateAnchor?> getLineTranslateAnchor()
    => messager.getLineTranslateAnchor(id).then((value) => value != null ? LineTranslateAnchor.values[value] : null);
