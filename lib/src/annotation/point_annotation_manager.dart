...
class PointAnnotationManager extends BaseAnnotationManager {
  PointAnnotationManager({required String id, required BinaryMessenger messenger}) : super(id: id, messenger: messenger);

  late _PointAnnotationMessager messager = _PointAnnotationMessager(binaryMessenger: _messenger);

  /// Add a listener to receive the callback when an annotation is clicked.
  void addOnPointAnnotationClickListener(OnPointAnnotationClickListener listener) {
  ...
  Future<List<PointAnnotation?>> createMulti(List<PointAnnotationOptions> annotations) =>
      messager.createMulti(id, annotations);

  /// Update an added annotation with new properties.
  Future<void> update(PointAnnotation annotation) => messager.update(id, annotation);

  /// Delete an added annotation.
  Future<void> delete(PointAnnotation annotation) => messager.delete(id, annotation);
  ...
  Future<bool?> getIconAllowOverlap()
    => messager.getIconAllowOverlap(id);
  ...
  Future<bool?> getIconIgnorePlacement()
    => messager.getIconIgnorePlacement(id);
  ...
  Future<bool?> getIconKeepUpright()
    => messager.getIconKeepUpright(id);
  ...
  Future<IconPitchAlignment?> getIconPitchAlignment()
    => messager.getIconPitchAlignment(id).then((value) => value != null ? IconPitchAlignment.values[value] : null);

  /// In combination with `symbol-placement`, determines the rotation behavior of icons.
  Future<void> setIconRotationAlignment(IconRotationAlignment iconRotationAlignment)
    => messager.setIconRotationAlignment(id, iconRotationAlignment);

  /// In combination with `symbol-placement`, determines the rotation behavior of icons.
  Future<IconRotationAlignment?> getIconRotationAlignment()
    => messager.getIconRotationAlignment(id).then((value) => value != null ? IconRotationAlignment.values[value] : null);
  ...
  Future<IconTextFit?> getIconTextFit()
    => messager.getIconTextFit(id).then((value) => value != null ? IconTextFit.values[value] : null);
  ...
  Future<bool?> getSymbolAvoidEdges()
    => messager.getSymbolAvoidEdges(id);
  ...
  Future<SymbolPlacement?> getSymbolPlacement()
    => messager.getSymbolPlacement(id).then((value) => value != null ? SymbolPlacement.values[value] : null);
  ...
  Future<SymbolZOrder?> getSymbolZOrder()
    => messager.getSymbolZOrder(id).then((value) => value != null ? SymbolZOrder.values[value] : null);
  ...
  Future<bool?> getTextAllowOverlap()
    => messager.getTextAllowOverlap(id);
  ...
  Future<bool?> getTextIgnorePlacement()
    => messager.getTextIgnorePlacement(id);
  ...
  Future<bool?> getTextKeepUpright()
    => messager.getTextKeepUpright(id);
  ...
  Future<TextPitchAlignment?> getTextPitchAlignment()
    => messager.getTextPitchAlignment(id).then((value) => value != null ? TextPitchAlignment.values[value] : null);

  /// In combination with `symbol-placement`, determines the rotation behavior of the individual glyphs forming the text.
  Future<void> setTextRotationAlignment(TextRotationAlignment textRotationAlignment)
    => messager.setTextRotationAlignment(id, textRotationAlignment);

  /// In combination with `symbol-placement`, determines the rotation behavior of the individual glyphs forming the text.
  Future<TextRotationAlignment?> getTextRotationAlignment()
    => messager.getTextRotationAlignment(id).then((value) => value != null ? TextRotationAlignment.values[value] : null);
  ...
  Future<IconTranslateAnchor?> getIconTranslateAnchor()
    => messager.getIconTranslateAnchor(id).then((value) => value != null ? IconTranslateAnchor.values[value] : null);
  ...
  Future<TextTranslateAnchor?> getTextTranslateAnchor()
    => messager.getTextTranslateAnchor(id).then((value) => value != null ? TextTranslateAnchor.values[value] : null);
}
