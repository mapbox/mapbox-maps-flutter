...
class MapView extends StatefulWidget {
  ...
  /// Resource options when using a MapView. Access token required when using a Mapbox service. Please see [https://www.mapbox.com/help/create-api-access-token/](https://www.mapbox.com/help/create-api-access-token/) to learn how to create one.More information in this guide [https://www.mapbox.com/help/first-steps-android-sdk/#access-tokens](https://www.mapbox.com/help/first-steps-android-sdk/#access-tokens).
  ...
  /// Flag indicating to use a TextureView as render surface for the MapView. Default is false. Only works for Android.
  final bool? textureView;

  /// The styleUri will applied for the MapView in the onStart lifecycle event if no style is set. Default is [Style.MAPBOX_STREETS].
  ...
  final _mapViewState = _MapViewState();
  final _eventTypes = [];
  ...
  MapboxMap getMapboxMap() => _mapViewState.mapboxMap;
}
