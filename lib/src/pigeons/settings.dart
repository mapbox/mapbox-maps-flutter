...
class LocationPuck2D {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(topImage, other.topImage) &&
        _deepEquals(bearingImage, other.bearingImage) &&
        _deepEquals(shadowImage, other.shadowImage) &&
...
class _LocationComponentSettingsInterface {
  ...
  Future<void> updateSettings(
    ...
    final Future<Object?> pigeonVar_sendFuture =
        pigeonVar_channel.send(<Object?>[settings, useDefaultPuck2DIfNeeded]);
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
