...
class _MapInterface {
  ...
  Future<void> setNorthOrientation(NorthOrientation orientation) async {
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[orientation]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
  ...
  Future<void> setSnapshotLegacyMode(bool enabled) async {
    final String __pigeon_channelName =
        'dev.flutter.pigeon.mapbox_maps_flutter._MapInterface.setSnapshotLegacyMode$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel =
        BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
...
class _MapboxMapsOptions {
  ...
  Future<TileStoreUsageMode> getTileStoreUsageMode() async {
    ...
    if (__pigeon_replyList == null) {
      ...
      return (__pigeon_replyList[0] as TileStoreUsageMode?)!;
    }
  }
