...
class RenderCacheOptions {
  ...
  static RenderCacheOptions decode(Object message) {
    final Map<Object?, Object?> pigeonMap = message as Map<Object?, Object?>;
...
class __CameraManagerCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is CameraBounds) {
      ...
      buffer.putUint8(151);
      writeValue(buffer, value.encode());
    } else if (value is RenderCacheOptions) {
      buffer.putUint8(152);
      writeValue(buffer, value.encode());
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 152:
        return RenderCacheOptions.decode(readValue(buffer)!);
...
class _CameraManager {
  ...
  Future<CameraOptions> cameraForCoordinates2(
    ...
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon._CameraManager.cameraForCoordinates2', codec,
        binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
...
class _MapInterface {
  ...
  Future<void> setRenderCacheOptions(RenderCacheOptions arg_options) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon._MapInterface.setRenderCacheOptions', codec,
        binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object?>[arg_options]) as Map<Object?, Object?>?;
    if (replyMap == null) {
  ...
  Future<RenderCacheOptions> getRenderCacheOptions() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon._MapInterface.getRenderCacheOptions', codec,
        binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(null) as Map<Object?, Object?>?;
    if (replyMap == null) {
      ...
      return (replyMap['result'] as RenderCacheOptions?)!;
    }
  }
}
