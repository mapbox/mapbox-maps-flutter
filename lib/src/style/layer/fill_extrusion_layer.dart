...
@override
  String _encode() {
    ...
    if (fillExtrusionAmbientOcclusionGroundAttenuation != null) {
      paint["fill-extrusion-ambient-occlusion-ground-attenuation"] = fillExtrusionAmbientOcclusionGroundAttenuation;
    }
    if (fillExtrusionAmbientOcclusionGroundRadius != null) {
      paint["fill-extrusion-ambient-occlusion-ground-radius"] = fillExtrusionAmbientOcclusionGroundRadius;
    }
    if (fillExtrusionAmbientOcclusionIntensity != null) {
      paint["fill-extrusion-ambient-occlusion-intensity"] = fillExtrusionAmbientOcclusionIntensity;
    }
    if (fillExtrusionAmbientOcclusionRadius != null) {
      paint["fill-extrusion-ambient-occlusion-radius"] = fillExtrusionAmbientOcclusionRadius;
    }
    if (fillExtrusionAmbientOcclusionWallRadius != null) {
      paint["fill-extrusion-ambient-occlusion-wall-radius"] = fillExtrusionAmbientOcclusionWallRadius;
    }
    ...
    if (fillExtrusionFloodLightColor != null) {
      paint["fill-extrusion-flood-light-color"] = fillExtrusionFloodLightColor?.toRGBA();
    }
    if (fillExtrusionFloodLightGroundAttenuation != null) {
      paint["fill-extrusion-flood-light-ground-attenuation"] = fillExtrusionFloodLightGroundAttenuation;
    }
    if (fillExtrusionFloodLightGroundRadius != null) {
      paint["fill-extrusion-flood-light-ground-radius"] = fillExtrusionFloodLightGroundRadius;
    }
    if (fillExtrusionFloodLightIntensity != null) {
      paint["fill-extrusion-flood-light-intensity"] = fillExtrusionFloodLightIntensity;
    }
    if (fillExtrusionFloodLightWallRadius != null) {
      paint["fill-extrusion-flood-light-wall-radius"] = fillExtrusionFloodLightWallRadius;
    }
  ...
  static FillExtrusionLayer decode(String properties) {
    ...
    return FillExtrusionLayer(id: map["id"],
      ...
      fillExtrusionEdgeRadius: map["layout"]["fill-extrusion-edge-radius"] is num? ? (map["layout"]["fill-extrusion-edge-radius"] as num?)?.toDouble() : null,
      fillExtrusionAmbientOcclusionGroundAttenuation: map["paint"]["fill-extrusion-ambient-occlusion-ground-attenuation"] is num? ? (map["paint"]["fill-extrusion-ambient-occlusion-ground-attenuation"] as num?)?.toDouble() : null,
      fillExtrusionAmbientOcclusionGroundRadius: map["paint"]["fill-extrusion-ambient-occlusion-ground-radius"] is num? ? (map["paint"]["fill-extrusion-ambient-occlusion-ground-radius"] as num?)?.toDouble() : null,
      fillExtrusionAmbientOcclusionIntensity: map["paint"]["fill-extrusion-ambient-occlusion-intensity"] is num? ? (map["paint"]["fill-extrusion-ambient-occlusion-intensity"] as num?)?.toDouble() : null,
      fillExtrusionAmbientOcclusionRadius: map["paint"]["fill-extrusion-ambient-occlusion-radius"] is num? ? (map["paint"]["fill-extrusion-ambient-occlusion-radius"] as num?)?.toDouble() : null,
      fillExtrusionAmbientOcclusionWallRadius: map["paint"]["fill-extrusion-ambient-occlusion-wall-radius"] is num? ? (map["paint"]["fill-extrusion-ambient-occlusion-wall-radius"] as num?)?.toDouble() : null,
      ...
      fillExtrusionCutoffFadeRange: map["paint"]["fill-extrusion-cutoff-fade-range"] is num? ? (map["paint"]["fill-extrusion-cutoff-fade-range"] as num?)?.toDouble() : null,
      fillExtrusionFloodLightColor: (map["paint"]["fill-extrusion-flood-light-color"] as List?)?.toRGBAInt(),
      fillExtrusionFloodLightGroundAttenuation: map["paint"]["fill-extrusion-flood-light-ground-attenuation"] is num? ? (map["paint"]["fill-extrusion-flood-light-ground-attenuation"] as num?)?.toDouble() : null,
      fillExtrusionFloodLightGroundRadius: map["paint"]["fill-extrusion-flood-light-ground-radius"] is num? ? (map["paint"]["fill-extrusion-flood-light-ground-radius"] as num?)?.toDouble() : null,
      fillExtrusionFloodLightIntensity: map["paint"]["fill-extrusion-flood-light-intensity"] is num? ? (map["paint"]["fill-extrusion-flood-light-intensity"] as num?)?.toDouble() : null,
      fillExtrusionFloodLightWallRadius: map["paint"]["fill-extrusion-flood-light-wall-radius"] is num? ? (map["paint"]["fill-extrusion-flood-light-wall-radius"] as num?)?.toDouble() : null,
      ...
      fillExtrusionPattern: map["paint"]["fill-extrusion-pattern"] is String? ? map["paint"]["fill-extrusion-pattern"] as String? : null,
      fillExtrusionRoundedRoof: map["paint"]["fill-extrusion-rounded-roof"] is bool? ? map["paint"]["fill-extrusion-rounded-roof"] as bool? : null,
      ...
      fillExtrusionVerticalGradient: map["paint"]["fill-extrusion-vertical-gradient"] is bool? ? map["paint"]["fill-extrusion-vertical-gradient"] as bool? : null,
      fillExtrusionVerticalScale: map["paint"]["fill-extrusion-vertical-scale"] is num? ? (map["paint"]["fill-extrusion-vertical-scale"] as num?)?.toDouble() : null,
    );
  }
}
