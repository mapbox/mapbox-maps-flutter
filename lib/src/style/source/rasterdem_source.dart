...
class RasterDemSource extends Source {
  ...
  Future< Encoding?> get encoding async {
    return _style?.getStyleSourceProperty(id, "encoding").then((value){
        if(value.value != '<null>') {
          return Encoding.values.firstWhere((e) => e.toString().split('.').last.toLowerCase().contains(value.value));
        } else {
            return null;
        }
    });
  ...
  Future< double?> get prefetchZoomDelta async {
    return _style?.getStyleSourceProperty(id, "prefetch-zoom-delta").then((value){
        if(value.value != '<null>') {
          return double.parse(value.value);
        } else {
            return null;
  ...
  Future< double?> get minimumTileUpdateInterval async {
    return _style?.getStyleSourceProperty(id, "minimum-tile-update-interval").then((value){
        if(value.value != '<null>') {
          return double.parse(value.value);
        } else {
            return null;
  ...
  Future< double?> get maxOverscaleFactorForParentTiles async {
    return _style?.getStyleSourceProperty(id, "max-overscale-factor-for-parent-tiles").then((value){
        if(value.value != '<null>') {
          return double.parse(value.value);
        } else {
            return null;
  ...
  Future< double?> get tileRequestsDelay async {
    return _style?.getStyleSourceProperty(id, "tile-requests-delay").then((value){
        if(value.value != '<null>') {
          return double.parse(value.value);
        } else {
            return null;
  ...
  Future< double?> get tileNetworkRequestsDelay async {
    return _style?.getStyleSourceProperty(id, "tile-network-requests-delay").then((value){
        if(value.value != '<null>') {
          return double.parse(value.value);
        } else {
            return null;
  ...
  String _encode(bool volatile) {
    ...
    if (_maxOverscaleFactorForParentTiles != null) {
      properties["max-overscale-factor-for-parent-tiles"] = _maxOverscaleFactorForParentTiles;
    }
    ...
    if (_encoding != null) {
      properties["encoding"] = _encoding.toString().split('.').last.toLowerCase();
    }
    if (_volatile != null) {
