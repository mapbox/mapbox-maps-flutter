...
public class FLTMapboxMap {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static class RenderCacheOptions {
    private @Nullable Long size;
    ...
    public static final class Builder {
      ...
      public @NonNull RenderCacheOptions build() {
        RenderCacheOptions pigeonReturn = new RenderCacheOptions();
        pigeonReturn.setSize(size);
        return pigeonReturn;
      }
    }
    ...
    static @NonNull RenderCacheOptions fromMap(@NonNull Map<String, Object> map) {
      RenderCacheOptions pigeonResult = new RenderCacheOptions();
      Object size = map.get("size");
      pigeonResult.setSize((size == null) ? null : ((size instanceof Integer) ? (Integer)size : (Long)size));
      return pigeonResult;
    }
  ...
  private static class _CameraManagerCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, ByteBuffer buffer) {
      switch (type) {
        ...
        case (byte)152:         
          return RenderCacheOptions.fromMap((Map<String, Object>) readValue(buffer));
    ...
    protected void writeValue(ByteArrayOutputStream stream, Object value)     {
      ...
      if (value instanceof RenderCacheOptions) {
        stream.write(152);
        writeValue(stream, ((RenderCacheOptions) value).toMap());
      } else 
      ...
      } else 
{
  ...
  public interface _CameraManager {
    ...
    @NonNull CameraOptions cameraForCoordinates2(@NonNull List<Map<String, Object>> coordinates, @NonNull CameraOptions camera, @NonNull ScreenBox box);
    ...
    static void setup(BinaryMessenger binaryMessenger, _CameraManager api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon._CameraManager.cameraForCoordinates2", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              ...
              CameraOptions output = api.cameraForCoordinates2(coordinatesArg, cameraArg, boxArg);
              wrapped.put("result", output);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
      ...
      } else 
{
  ...
  public interface _MapInterface {
    ...
    void setRenderCacheOptions(@NonNull RenderCacheOptions options);
    @NonNull RenderCacheOptions getRenderCacheOptions();
    ...
    static void setup(BinaryMessenger binaryMessenger, _MapInterface api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon._MapInterface.setRenderCacheOptions", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              ArrayList<Object> args = (ArrayList<Object>)message;
              RenderCacheOptions optionsArg = (RenderCacheOptions)args.get(0);
              if (optionsArg == null) {
                throw new NullPointerException("optionsArg unexpectedly null.");
              }
              api.setRenderCacheOptions(optionsArg);
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon._MapInterface.getRenderCacheOptions", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              RenderCacheOptions output = api.getRenderCacheOptions();
              wrapped.put("result", output);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
