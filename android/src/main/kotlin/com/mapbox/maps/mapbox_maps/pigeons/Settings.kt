...
data class GesturesSettings(
  ...
  companion object {
    ...
    fun fromList(list: List<Any?>): GesturesSettings {
      ...
      val scrollMode: ScrollMode? = (list[5] as Int?)?.let {
        ScrollMode.ofRaw(it)
      }
      ...
      val focalPoint: ScreenCoordinate? = (list[9] as List<Any?>?)?.let {
...
data class LocationPuck3D(
  ...
  companion object {
    ...
    fun fromList(list: List<Any?>): LocationPuck3D {
      ...
      val modelScaleMode: ModelScaleMode? = (list[9] as Int?)?.let {
...
data class LocationPuck(
  ...
  companion object {
    ...
    fun fromList(list: List<Any?>): LocationPuck {
      val locationPuck2D: LocationPuck2D? = (list[0] as List<Any?>?)?.let {
        LocationPuck2D.fromList(it)
      }
      val locationPuck3D: LocationPuck3D? = (list[1] as List<Any?>?)?.let {
...
data class LocationComponentSettings(
  ...
  companion object {
    ...
    fun fromList(list: List<Any?>): LocationComponentSettings {
      ...
      val puckBearing: PuckBearing? = (list[10] as Int?)?.let {
        PuckBearing.ofRaw(it)
      }
      val locationPuck: LocationPuck? = (list[11] as List<Any?>?)?.let {
...
data class ScaleBarSettings(
  ...
  companion object {
    ...
    fun fromList(list: List<Any?>): ScaleBarSettings {
      val enabled = list[0] as Boolean?
      val position: OrnamentPosition? = (list[1] as Int?)?.let {
...
data class LogoSettings(
  ...
  companion object {
    ...
    fun fromList(list: List<Any?>): LogoSettings {
      val position: OrnamentPosition? = (list[0] as Int?)?.let {
        OrnamentPosition.ofRaw(it)
      }
